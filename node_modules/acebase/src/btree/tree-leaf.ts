...
export class BPlusTreeLeaf {
    ...
    prevLeaf: BPlusTreeLeaf = null;
    nextLeaf: BPlusTreeLeaf = null;

    constructor(public parent: BPlusTree | BPlusTreeNode) {
    }
     ...
     */
    add(key: NodeEntryKeyType, recordPointer: number[] | Uint8Array | string, metadata?: LeafEntryMetaData) {
    ...
    async toBinary(keepFreeSpace = false, writer: BinaryWriter) {
        ...
        const moreDataBlocks: Array<{  pointerIndex: number;  bytes: number[] }> = [];
        this.entries.forEach(entry => {
            ...
            const writeValue = (entryValue: BPlusTreeLeafEntryValue) => {
