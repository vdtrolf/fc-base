 ...
 */
export const encode = function (lat, lon, precision) {
    // infer precision?
 ...
 */
export const decode = function (geohash) {
 ...
 */
export const bounds = function (geohash) {
    if (geohash.length === 0)
        throw new Error('Invalid geohash');
 ...
 * @throws  Invalid
 */
export const adjacent = function (geohash, direction) {
 ...
 */
export const neighbours = function (geohash) {
    return {
