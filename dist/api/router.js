...
const getNamesList_1 = require("./getNamesList");
const getName_1 = require("./getName");
const createName_1 = require("./createName");
const getScoresList_1 = require("./getScoresList");
const getScore_1 = require("./getScore");
const createScore_1 = require("./createScore");
const getUsersList_1 = require("./getUsersList");
const getUser_1 = require("./getUser");
const createUser_1 = require("./createUser");
const island_1 = __importDefault(require("../models/island"));
...
const idsHelper_1 = require("../services/idsHelper");
// Constants
